...
public class ProrrogaOficioConsultaDTO implements Serializable {

    /**
     *
     */
    private static final long serialVersionUID = -2573236082360310546L;
    ...
    private List<FecetDocProrrogaOficio> listFecetDocProrrogaOficio;
    private FlujoProrrogaOficioConsultaDTO flujoProrrogaOficioConsultaDTO;
    ...
    public List<FecetDocProrrogaOficio> getListFecetDocProrrogaOficio() {
        return listFecetDocProrrogaOficio;
    }

    public void setListFecetDocProrrogaOficio(List<FecetDocProrrogaOficio> listFecetDocProrrogaOficio) {
        this.listFecetDocProrrogaOficio = listFecetDocProrrogaOficio;
    ...
    public FlujoProrrogaOficioConsultaDTO getFlujoProrrogaOficioConsultaDTO() {
        return flujoProrrogaOficioConsultaDTO;
    }

    public void setFlujoProrrogaOficioConsultaDTO(FlujoProrrogaOficioConsultaDTO flujoProrrogaOficioConsultaDTO) {
        this.flujoProrrogaOficioConsultaDTO = flujoProrrogaOficioConsultaDTO;
    }
