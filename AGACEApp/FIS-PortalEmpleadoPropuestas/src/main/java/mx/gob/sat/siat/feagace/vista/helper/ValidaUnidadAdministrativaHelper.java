...
public class ValidaUnidadAdministrativaHelper implements Serializable  {
    ...
    public CargaMasivaPropuestasDTO validaUnidadAdministrativa(String cell,
        ...
        BigDecimal unidadEmpleado = new BigDecimal(cargaMasivaPropuestasDTO.getFecetPropuesta().getEmpleadoDto().getDetalleEmpleado().get(0).getCentral().getIdArace());
    ...
    public boolean contieneUnidad(String unidadSeleccionada) {
        return !unidadSeleccionada.equals(UnidadAdministrativaEnum.ACAOCE.getDescUnidad())
