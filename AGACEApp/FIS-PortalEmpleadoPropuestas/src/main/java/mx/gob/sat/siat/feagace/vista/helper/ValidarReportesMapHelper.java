...
public class ValidarReportesMapHelper extends BaseHelper implements Serializable {
    ...
    @SuppressWarnings("compatibility:5547836846763120071")
    ...
    public List<Map<String, ?>> listaPistaAudit(List<ReportePistaAuditoriaInternaDTO> listRepInterno) {
        ...
        for (ReportePistaAuditoriaInternaDTO dto : listRepInterno) {
            Map<String, Object> mapDto = new HashMap<String, Object>();
            mapDto.put("fechaYHora",
                       dto.getFechaYHora() != null ? this.getFormatoFecha().format(dto.getFechaYHora()) : "");
            mapDto.put("rfcUsuario", dto.getRfcUsuario() != null ? dto.getRfcUsuario() : "");
            mapDto.put("nomUsuario", dto.getNomUsuario() != null ? dto.getNomUsuario() : "");
            mapDto.put("ipMaquina", dto.getIpMaquina() != null ? dto.getIpMaquina() : "");
            mapDto.put("nomMaquina", dto.getNomMaquina() != null ? dto.getNomMaquina() : "");
