...
public class FecetPromocionOficio extends BaseModel {
     ...
     */
    public FecetPromocionOficioPk createPk() {
        return new FecetPromocionOficioPk(idPromocionOficio);
    }
