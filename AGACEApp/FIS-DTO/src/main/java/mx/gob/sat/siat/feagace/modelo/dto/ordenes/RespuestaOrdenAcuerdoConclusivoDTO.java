...
public class RespuestaOrdenAcuerdoConclusivoDTO extends BaseModel implements Serializable {

    private static final long serialVersionUID = 3371827469760121913L;
    ...
    /**
     * @param rfcContribuyente the rfcContribuyente to set
     */
    ...
    /**
     * @param ejercicioInicio the ejercicioInicio to set
     */
    ...
    /**
     * @param ejercicioFin the ejercicioFin to set
     */
    ...
    /**
     * @param actividadPreponderante the actividadPreponderante to set
     */
    ...
    /**
     * @return the estatusConsulta
     */
    public Integer getEstatusConsulta() {
        return estatusConsulta;
    }

    /**
     * @param estatusConsulta the estatusConsulta to set
     */
    public void setEstatusConsulta(Integer estatusConsulta) {
