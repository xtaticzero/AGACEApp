...
public class ConsultarReimprimirDocumentosHelper {
    ...
    /**
     * Convierte el objeto de dominio AgaceOrden a OrdenConsulta para presentar en la vista.
     * 
    ...
    public List<OrdenConsultaDTO> convertToOrdenConsulta(List<AgaceOrden> listAgaceOrden, String rfc) {
        ...
        for (AgaceOrden agaceOrden : listAgaceOrden) {
            ...
            ordenConsultaDTO.setRutaArchivo(RutaArchivosUtilContribuyente.armarRutaDocOrden(agaceOrden));
            ordenConsultaDTO.setNombreArchivo(CargaArchivoUtilContribuyente.getNombreArchivoOrdenPdf(agaceOrden));
    ...
    /**
     * Convierte el objeto de dominio FecetPromocion a PromocionConsultaDTO para presentar en la vista.
     * 
     * @param listFecetPromocion
     * @param
     * @return
     */
    public List<PromocionConsultaDTO> convertToPromocionConsulta(List<FecetPromocion> listFecetPromocion,
        ...
        for (FecetPromocion fecetPromocion : listFecetPromocion) {
            ...
            promocionConsultaDTO.setExtemporaneo(
                    fecetPromocion.getExtemporanea() != null && fecetPromocion.getExtemporanea().equals("1") ? true
                            : false);
    ...
    /**
     * Convierte el objeto de dominio FecetProrrogaOrden a ProrrogaOrdenConsultaDTO para presentar en la vista.
     * 
     * @param listFecetProrrogaOrden
     * @return
     */
    public List<ProrrogaOrdenConsultaDTO> convertoToProrrogaOrdenConsulta(
            List<FecetProrrogaOrden> listFecetProrrogaOrden, OrdenConsultaDTO ordenConsulta) {
        ...
        for (FecetProrrogaOrden fecetProrrogaOrden : listFecetProrrogaOrden) {
            ...
            prorrogaOrdenConsultaDTO
                    .setTotalDocumentosContribuyente(fecetProrrogaOrden.getTotalDocumentosContribuyente());
            ...
            // Cuando el campo idAsociado es null la presentacion fue realizada
            // por el contribuyente.
            if (fecetProrrogaOrden.getFecetAsociado() != null
                    && fecetProrrogaOrden.getFecetAsociado().getNombre() != null) {
            ...
            prorrogaOrdenConsultaDTO.setEstatus(fecetProrrogaOrden.getFececEstatus() != null
                    ? fecetProrrogaOrden.getFececEstatus().getDescripcion() : null);
    ...
    /**
     * Convierte el objeto de dominio FecetOficio a OficioConsultaDTO para presentar en la vista.
     * 
     * @param listFecetOficio
     * @return
     */
    public List<OficioConsultaDTO> convertToOficioConsultaDTO(List<FecetOficio> listFecetOficio,
            OrdenConsultaDTO ordenConsultaDTO, OficioConsultaDTO oficioConsultaSeleccionado) {
        ...
        for (FecetOficio fecetOficio : listFecetOficio) {
            ...
            oficioConsultaDTO.setFechaNotificacion(fecetOficio.getFechaNotifNyv());
            ...
            oficioConsultaDTO.setPresentadoPor(
                    ordenConsultaDTO.getFirmante() != null ? ordenConsultaDTO.getFirmante().getNombre() : null);
    ...
    /**
     * Convierte el objeto de dominio FecetPromocionOficio a PromocionOficioConsultaDTO para presentar en la vista.
     * 
     * @param listFecetPromocionOficio
     * @return
     */
    public List<PromocionOficioConsultaDTO> convertToPromocionOficioConsultaDTO(
            List<FecetPromocionOficio> listFecetPromocionOficio, BigDecimal idTipo, OrdenConsultaDTO ordenConsulta) {
        ...
        for (FecetPromocionOficio fecetPromocionOficio : listFecetPromocionOficio) {
            ...
            promocionOficioConsultaDTO.setExtemporaneo(
                    fecetPromocionOficio.getExtemporanea() != null && fecetPromocionOficio.getExtemporanea().equals("1")
                            ? true : false);
            // Regla no definida en C.U.
            // Cuando el campo idAsociado es null la presentacion fue realizada
            // por el contribuyente.
    ...
    /**
     * Convierte el objeto de domicio FecetProrrogaOficio a ProrrogaOficioConsultaDTO para presentar en vista.
     * 
     * @param listFecetProrrogaOficio
     * @return
     */
    public List<ProrrogaOficioConsultaDTO> convertToProrrogaOficioConsultaDTO(
            List<FecetProrrogaOficio> listFecetProrrogaOficio, OficioConsultaDTO oficio,
            OrdenConsultaDTO ordenConsulta) {
        ...
        for (FecetProrrogaOficio fecetProrrogaOficio : listFecetProrrogaOficio) {
            ...
            prorrogaOficioConsultaDTO
                    .setTotalDocumentosContribuyente(fecetProrrogaOficio.getTotalDocumentosContribuyente());
            ...
            prorrogaOficioConsultaDTO.setEstatus(fecetProrrogaOficio.getFececEstatus() != null
                    ? fecetProrrogaOficio.getFececEstatus().getDescripcion() : null);
            if (fecetProrrogaOficio.getFecetAsociado() != null
                    && fecetProrrogaOficio.getFecetAsociado().getNombre() != null) {
    ...
    /**
     * Convierte el objeto de domicio FecetFlujoProrrogaOficio a FlujoProrrogaOficioConsultaDTO para presentar en vista.
     * 
     * @param fecetFlujoProrrogaOficio
     * @return
     */
    public FlujoProrrogaOficioConsultaDTO convertToFlujoProrrogaOficioConsultaDTO(
            FecetFlujoProrrogaOficio fecetFlujoProrrogaOficio) {
    ...
    public FlujoProrrogaOrdenConsultaDTO convertToFlujoProrrogaOrdenConsultaDTO(
            FecetFlujoProrrogaOrden fecetFlujoProrrogaOrden) {
    ...
    public List<AnexoProrrogaOrdenConsultaDTO> convertToAnexoProrrogaOrdenConsultaDTO(
            List<FecetAnexosProrrogaOrden> listFecetAnexosProrrogaOrden) {
    ...
    public List<AnexoProrrogaOficioConsultaDTO> convertToAnexoProrrogaOficioConsultaDTO(
            List<FecetAnexosProrrogaOficio> listAnexosProrrogaOficios) {
        ...
        for (FecetAnexosProrrogaOficio fecetAnexosProrrogaOficio : listAnexosProrrogaOficios) {
            ...
            anexoProrrogaOficioConsultaDTO
                    .setIdFlujoProrrogaOficio(fecetAnexosProrrogaOficio.getIdFlujoProrrogaOficio());
    ...
    /**
     * Elimina las ordenes repetidas que continen la lista que recibe como parametro
     * 
     * @param listOrden
     * @return
     */
