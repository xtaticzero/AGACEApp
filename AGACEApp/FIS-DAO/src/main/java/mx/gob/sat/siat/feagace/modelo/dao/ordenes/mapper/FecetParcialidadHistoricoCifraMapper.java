...
public class FecetParcialidadHistoricoCifraMapper implements ParameterizedRowMapper<FecetParcialidadCifraDTO> {

    public static final String COLUMN_ID_PARCIALIDAD_CIFRA = "ID_PARCIALIDAD_HISTORICO";
