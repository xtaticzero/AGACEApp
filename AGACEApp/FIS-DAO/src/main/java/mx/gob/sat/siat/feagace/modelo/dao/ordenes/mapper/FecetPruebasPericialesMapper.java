...
public class FecetPruebasPericialesMapper implements ParameterizedRowMapper<FecetPruebasPericiales> {

    /**
     * Este atributo corresponde al nombre de la columna ID_PRUEBAS_PERICIALES
     * en la tabla FECET_PRUEBAS_PERICIALES
     */
     ...
     * la tabla FECET_PRUEBAS_PERICIALES
     */
     ...
     * tabla FECET_PRUEBAS_PERICIALES
     */
    ...
    public FecetPruebasPericiales mapRow(ResultSet rs, int rowNum) throws SQLException {
        FecetPruebasPericiales dto = new FecetPruebasPericiales();
