 ...
 */
public class FecetPropuestaDetalleMapper implements RowMapper<List<FecetPropuesta>> {
    ...
    /**
     * CAMPOS PARA FECEC_TIPO_CONCEPTO
     */
     ...
     */
    /**
     * CAMPO PARA ID_UNIDAD_ADMINISTRATIVA DEL INSUMO
     *
     */
    private static final String COLUMN_UNIDAD_ADMINISTRATIVA = "ID_UNIDAD_ADMINISTRATIVA";
    ...
    public List<FecetPropuesta> mapRow(ResultSet rs, int i) throws SQLException {
        ...
        do {
            if (validaDuplicidad(rs, lstPropuesta)) {
                ...
                if (UtileriasMapperDao.existeColumna(rs, COLUMN_UNIDAD_ADMINISTRATIVA)) {
                    FececUnidadAdministrativa unidadInsumo = new FececUnidadAdministrativa();
                    unidadInsumo.setIdUnidadAdministrativa(rs.getBigDecimal(COLUMN_UNIDAD_ADMINISTRATIVA));
                    propuesta.setUnidadAdministrativa(unidadInsumo);
                }
