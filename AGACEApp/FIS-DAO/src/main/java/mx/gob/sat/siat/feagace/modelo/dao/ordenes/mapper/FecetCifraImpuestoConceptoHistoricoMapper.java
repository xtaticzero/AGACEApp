...
public class FecetCifraImpuestoConceptoHistoricoMapper implements ParameterizedRowMapper<FeceaCifraImpuestoDTO> {
    ...
    public static final String COLUMN_ID_HISTORICO_CIFRA = "ID_HISTORICO_CIFRA";
    ...
    public FeceaCifraImpuestoDTO mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        fecetImpuestoCifraDTO.setIdHistoricoCifra(rs.getBigDecimal(COLUMN_ID_HISTORICO_CIFRA));
