...
public class ActoAdministrativoV2VOXml {

    protected long id;
    protected String nombre;
    protected String descripcion;
    protected String prefijoReferencia;
    protected List<TipoDocumentoV2VOXml> documento;
     ...
     * {@link TipoDocumentoV2VOXml }
     *
     *
     */
    public List<TipoDocumentoV2VOXml> getDocumento() {
        if (documento == null) {
            documento = new ArrayList<TipoDocumentoV2VOXml>();
        }
