...
public class ResponseConsultaActosAdmin {
    ...
    protected List<ActoAdministrativoV1VOXml> actoAdmin;
     ...
     * {@link ActoAdministrativoV1VOXml }
     *
     *
     */
    public List<ActoAdministrativoV1VOXml> getActoAdmin() {
        if (actoAdmin == null) {
            actoAdmin = new ArrayList<ActoAdministrativoV1VOXml>();
        }
