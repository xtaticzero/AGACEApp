...
public class DetalleOficioUnifHelper implements Serializable {
    ...
    private List<FecetDocProrrogaOficio> listaDocumentosProrrogaOficio;
    ...
    public void setDocumentacionProrrogaOficioSeleccionado(final FecetDocProrrogaOficio documentacionProrrogaOficioSeleccionado) {
    ...
    public List<FecetDocProrrogaOficio> getListaDocumentosProrrogaOficio() {
        return listaDocumentosProrrogaOficio;
    }

    public void setListaDocumentosProrrogaOficio(List<FecetDocProrrogaOficio> listaDocumentosProrrogaOficio) {
        this.listaDocumentosProrrogaOficio = listaDocumentosProrrogaOficio;
    }
