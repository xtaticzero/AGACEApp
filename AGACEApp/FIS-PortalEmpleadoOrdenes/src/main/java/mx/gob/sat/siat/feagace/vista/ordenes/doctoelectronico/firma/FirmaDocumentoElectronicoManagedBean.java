...
public class FirmaDocumentoElectronicoManagedBean extends FirmaManagedBean {
    ...
    public void init() {
        ...
        setOrdenesPorFirmar((List<OrdenPorFirmar>) getSession().getAttribute("ordenesPorFirmar"));
    }
        ...
        if (this.ordenesPorFirmar != null && !this.ordenesPorFirmar.isEmpty()) {
            ...
            for (OrdenPorFirmar orden : ordenesPorFirmar) {
                if (orden.getRutaArchivo() == null) {
                    ...
                    FacesUtil.addErrorMessage(null, errorMsg.toString());
                    firma = false;
                }
            }
            if (firma) {
            ...
            FacesUtil.addErrorMessage(null, FacesUtil.getMessageResourceString(SIN_SELECCION));
        }
    }
