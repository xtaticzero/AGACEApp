package mx.gob.sat.siat.feagace.vista.ordenes.documentacion.aduanal;
...
public abstract class DocumentacionAgAduanalAbstractMB extends AbstractManagedBean {
    ...
    public StreamedContent getArchivoPromocionAgenteAduanal() {
        StreamedContent content = null;
        content = getArchivoDescargaPromocion();
        getPistaAuditoriaDescargaDocumentosService().consultarPromocionAgenteAduanal(getOrdenSeleccionado());
        return content;
    }

    public StreamedContent getArchivoPromocionAnexosAgenteAduanal() {
        StreamedContent content = null;
        content = getArchivoDescargaPruebasAlegatos();
        getPistaAuditoriaDescargaDocumentosService().consultarPromocionAnexoAgenteAduanal(getOrdenSeleccionado());
        return content;
    }
