...
public abstract class InformeRechazoManagedBean extends BaseManagedBean {
    ...
    public void setListaFececActividadPreponderante(
            List<FececActividadPreponderante> listaFececActividadPreponderante) {
